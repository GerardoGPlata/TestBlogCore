...
function loadDataTable() {
    dataTable = $('#tlbArticles').DataTable({
        "ajax": {
        ...
        "columns": [
            ...
            { "data": "category.name", "width": "20%" },
            {
                ...
                "render": function (image) {
                    return `<img src="../${image}" width="120px" alt="Artículo"/>`;
                }
            },
                ...
                "render": function (data) {
                    return `
                        <div class="text-center">
                            ...
                            <a onclick=Delete("/Admin/Articles/Delete/${data}") class="btn btn-danger text-white" style="cursor:pointer">
